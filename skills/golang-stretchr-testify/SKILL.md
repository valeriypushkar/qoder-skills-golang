...
Use `testifylint` to catch wrong argument order, assert/require misuse, and more. See `golang-linter` skill.

## Cross-References

- → See `golang-testing` skill for general test patterns, table-driven tests, and CI
- → See `golang-linter` skill for testifylint configuration
