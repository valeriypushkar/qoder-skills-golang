...
This covers **function parameters**, not method receivers (see `valeriypushkar/qoder-skills-golang@golang-structs-interfaces` skill for receiver rules).
...
-> See the `valeriypushkar/qoder-skills-golang@golang-structs-interfaces` skill for pointer vs value **receiver** rules.
