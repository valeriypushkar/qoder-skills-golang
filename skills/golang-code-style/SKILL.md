...
description: Go code style, formatting and conventions. Use when writing code, reviewing style, configuring linters, writing comments, or establishing project standards.
---
...
Many rules are enforced automatically: `gofmt`, `gofumpt`, `goimports`, `gocritic`, `revive`, `wsl_v5`. → See the `golang-linter` skill.
...
- → See the `golang-linter` skill for automated formatting enforcement
