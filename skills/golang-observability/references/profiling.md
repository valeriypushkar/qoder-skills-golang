...
→ See `ggolang-troubleshooting` skill (pprof.md) for on-demand debugging.
...
→ See `ggolang-troubleshooting` pprof.md for the full pprof CLI reference (profile types, capturing, analyzing, commands).
