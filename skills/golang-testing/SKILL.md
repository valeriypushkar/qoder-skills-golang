...
Many test best practices are enforced automatically by linters: `thelper`, `paralleltest`, `testifylint`. See the `golang-linter` skill for configuration and usage.
...
- -> See `golang-linter` skill for testifylint and paralleltest configuration
