...
Create `.golangci.yml` at the root of the project. See the `golang-linter` skill for the recommended configuration.
...
See `golang-linter`, `golang-security`, `golang-testing`, `golang-dependency-management` skills.
