...
**Migration guidance**: For existing projects heavily invested in third-party loggers, migration is optional. For new projects, prefer `slog`. Go 1.24 added `slog.DiscardHandler` for silent loggers.
