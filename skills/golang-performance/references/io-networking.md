...
→ See `ggolang-concurrency` skill for detailed channel patterns and when to use worker pools instead.
...
→ See `ggolang-database` skill for detailed batch patterns and connection pool configuration.
