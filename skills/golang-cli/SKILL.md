---
name: golang-cli
description: Go CLI application development with Cobra and Viper. Use when building, modifying, or reviewing a Go CLI tool — for command structure, flag handling, configuration layering, version embedding, exit codes, I/O patterns, signal handling, shell completion, argument validation, and CLI unit testing. Also triggers when code uses cobra, viper, or urfave/cli.
---

# Go CLI Best Practices

Build tools that feel native to the Unix shell — composable, scriptable, and predictable under automation.
...
See [assets/examples/main.go](assets/examples/main.go) for minimal main.go.
