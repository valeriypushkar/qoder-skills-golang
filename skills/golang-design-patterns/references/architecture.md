...
→ See `valeriypushkar/qoder-skills-golang@golang-project-layout` for 12-Factor App conventions.
...
→ See `valeriypushkar/qoder-skills-golang@golang-project-layout` skill for directory structure and layout patterns.
