...
Construct adapters and inject them in `cmd/server/main.go`. → See `valeriypushkar/qoder-skills-golang@golang-dependency-injection` skill for DI library alternatives.
