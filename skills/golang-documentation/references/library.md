...
→ See `valeriypushkar/qoder-skills-golang@golang-testing` skill for writing effective Example test functions.
...
Create playground URLs manually at https://go.dev/play/ and share them.
