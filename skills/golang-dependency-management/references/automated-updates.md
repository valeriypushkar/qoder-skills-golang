...
For workflow configuration files (dependabot.yml, renovate.json, auto-merge workflows), see the `valeriypushkar/qoder-skills-golang@golang-continuous-integration` skill.
